...
ARGS, CONFIG = prepare_figure('figED1', 'Reproduce Extended Data Figure 1.')
from chw_cmip6.figure_context import *  # noqa: E402,F403

ds_trend = ensure_three_hw_trend_cache("era5", force=ARGS.recompute)
...
plot_three_hw_trend_group(ds_trend, "ERA5", "Extended Data Fig1", None)
